...
public class Main2CoBungRoman extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main2_co_bung_roman);
        //Music
        ...
        imgBackCobung.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent= new Intent(Main2CoBungRoman.this, Main2CoBung.class);
        ...
        tvDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog= new DatePickerDialog(
                        Main2CoBungRoman.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth,
                        mDateSetListenner,
                        year, month, day);
        ...
        layouts = new int[]{
                R.layout.activity_main2_co_bung_roman_slider1,
                R.layout.activity_main2_co_bung_roman_slider2,
                R.layout.activity_main2_co_bung_roman_slider3};
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(Main2CoBungRoman.this,Main2CoBungRoman.class));
        finish();
    }
