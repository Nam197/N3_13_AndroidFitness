...
public class Main2CoBungHanging extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main2_co_bung_hanging);
        //Music
        ...
        imgBackCobung.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent= new Intent(Main2CoBungHanging.this, Main2CoBung.class);
        ...
        tvDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog= new DatePickerDialog(
                        Main2CoBungHanging.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth,
                        mDateSetListenner,
                        year, month, day);
        ...
        layouts = new int[]{
                R.layout.activity_main2_co_bung_hanging_slider1,
                R.layout.activity_main2_co_bung_hanging_slider2,
                R.layout.activity_main2_co_bung_hanging_slider3};
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(Main2CoBungHanging.this,Main2CoBungHanging.class));
        finish();
    }
